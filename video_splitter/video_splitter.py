...
output_folder = os.path.join(os.getcwd(), "video_start_end")
    ...
    if file.endswith(".csv"):
        with open(file, mode='r', encoding='utf-8') as csv_file:
            ...
            for line in reader:
                ...
                os.system(f"ffmpeg -y -ss {start_time} -i \"{os.path.join(video_folder, input_video_name)}\" -t {end___time - start_time} -c:v copy -c:a copy \"{os.path.join(output_folder, output_video_name)}\"")
